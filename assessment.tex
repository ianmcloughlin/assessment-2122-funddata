...
\begin{document}
  ...
  \begin{description}
    \item[10\%] A clear and concise overview of viewpoints on the difference between data and information.
    \item[20\%] Demonstrations of interesting \texttt{numpy} functionality. You may choose these yourself, based on what is covered in class or otherwise. Note that the demonstrations are at your discretion -- you may choose to have an overall spread of examples across the library or pick a particular part that you find interesting.
  ...
  \begin{description}
    \item[15\%] A clear and concise comparison of how to use \texttt{matplotlib}.
    \item[25\%] An overview of plots in \texttt{seaborn}.
  \end{description}
