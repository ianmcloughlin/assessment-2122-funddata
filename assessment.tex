...
\begin{document}
  ...
  \subsubsection*{Data and Information Notebook}
  Include a Jupyter notebook called \texttt{data-and-information.ipynb} that contains the following.
  \begin{description}
    \item[10\%] A clear and concise overview of modern viewpoints on the difference between data and information.
    \item[20\%] An overview of the \texttt{numpy.random} package and the various probability distributions it covers.
    \item[10\%] Appropriate plots and other visualisations to enhance your notebook for viewers.
  \end{description}
  
  \subsubsection*{Visualisations Jupyter Notebook}
  Include a Jupyter notebook called \texttt{plots.ipynb} that contains the following.
  \begin{description}
    \item[15\%] A clear and concise overview of how to use the \texttt{matplotlib.pyplot} Python package~\cite{pyplot}.
    \item[25\%] An overview of three interesting plots from the \texttt{seaborn} Python package~\cite{seaborn}.
  \end{description}
